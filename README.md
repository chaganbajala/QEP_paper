...
- `paper_figs/figs/` — the figures these three notebooks already produced.
...
- `figures/shots_2026-09-11/` — the figures these two notebooks already produced.
...
- `figures/` — the figures `paper_figs.ipynb` already produced.
